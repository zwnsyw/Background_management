<template>
    <div class="users">
        ...
        <!-- 分配角色对话框 -->
        <el-dialog title="分配角色" :visible.sync="setRoleDialog" @close="roleDialogClose" width="50%">
            <div>
            ...
            <span slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="setRoleDialogInfo">确 定</el-button>
            </span>
        </el-dialog>
    </div>
</template>
